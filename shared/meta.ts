...
/** public/assets/index.json: every asset's meta, regenerated by the pipeline; the page fetches it at runtime. */
export const ASSET_INDEX = 'index.json'
export const ASSETS_EVENT = 'nc:assets'
